...
- [boogoo619/dsh-focus-overlay](https://github.com/boogoo619/dsh-focus-overlay) — 专注模式：一键进入全屏阅读视图，隐藏标题区、输入区与侧栏，把工具调用折叠为计数摘要，只保留对话本身；含轮次导航条、与主输入框共享草稿的底部输入坞，以及自动专注与新回复提醒。
